...
#A partir du code de Mr.Lurkin, j'ai des fonctions permettant à mon IA de ...
directions = [
    ( 0,  1),
    ( 0, -1),
    ( 1,  0),
...
#FCT DE MON IA ALEATOIRE
def ia1(state):
    mvt_possible= possibleMoves(state) 
    if len(mvt_possible)!=0:
        reponse_ia ={"response": "move","move": random.choice(mvt_possible),"message": "Ouss le + beau"} 
    else:
        reponse_ia ={"response": "move","move": None,"message": "Passe"} 
